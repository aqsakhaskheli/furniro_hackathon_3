    ...
    <>
      ...
      <div className="h-auto bg-[#FCF8F3] mt-10 flex flex-col lg:flex-row items-center justify-around">
        <div className="text-center lg:text-left px-6 lg:px-0">
          <h1 className="text-[32px] sm:text-[36px] md:text-[40px] text-gray-800 font-bold w-[90%] md:w-[422px]">
            50+ Beautiful rooms inspiration
          </h1>
          <p className="text-[14px] sm:text-[16px] mt-4 text-gray-800 md:mt-6 w-[90%] md:w-[368px]">
      ...
      <div className="md:flex flex-col justify-center items-center mb-[56.6px] hidden mt-36">
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-white font-[600] text-[20px] text-center leading-[30px] ">Share your setup with </h1>
          <h1 className="text-white font-[700] text-[40px] text-center leading-[48px] ">#FuniroFurniture </h1>
        </div>
